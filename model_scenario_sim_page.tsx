    ...
    <div className="flex flex-col h-[calc(100vh-140px)] -m-8 bg-[#f8fafc] font-sans">
      ...
      <div className="flex flex-1 overflow-hidden">
          ...
          <div className="p-5 space-y-6">
            <div className="space-y-2">
              ...
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-700 leading-relaxed italic">
                “Construction of an underground drainage pipeline along Gandhi
                Street to mitigate recurring flood risk during monsoon seasons.”
              </div>
            </div>
            ...
            <div className="pt-4 space-y-3">
              ...
              <div className="flex items-center gap-2 text-cyan-600">
                ...
                <span className="text-xs font-bold">AI insights generated</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 relative bg-slate-100 flex flex-col overflow-hidden">
          ...
          {/* Large Map Canvas (Simplified Mock) */}
          <div className="flex-1 bg-[#e2e8f0] relative overflow-hidden">
            <svg className="w-full h-full" viewBox="0 0 800 600">
              ...
              {/* Ward Boundary */}
              <path
                d="M100,100 L700,50 L750,500 L50,550 Z"
                fill="#ffffff"
                stroke="#94a3b8"
                strokeWidth="2"
              />
              ...
              {/* Flood Zones (Reduced intensity) */}
              <circle cx="350" cy="280" r="80" fill="#f43f5e" opacity="0.1" />
              <circle cx="550" cy="250" r="60" fill="#f43f5e" opacity="0.05" />

              {/* Tooltip Placeholder */}
              <g transform="translate(425, 200)">
                <rect width="160" height="50" rx="8" fill="#1e293b" />
                <text x="12" y="20" fill="#fff" fontSize="10" fontWeight="bold">
                  Gandhi Street Impact
                </text>
                <text x="12" y="38" fill="#2dd4bf" fontSize="9">
                  Drainage capacity improved. Flood risk reduced.
                </text>
              </g>
            </svg>
          </div>
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 border border-slate-100 rounded-xl bg-slate-50/50 space-y-3">
                ...
                <p className="text-[10px] text-slate-500 leading-tight">
                  Short-term increase during construction phase.
                </p>
              </div>
              ...
              <div className="p-4 border border-slate-100 rounded-xl bg-slate-50/50 space-y-3">
                ...
                <p className="text-[10px] text-slate-500 leading-tight">
                  Significant gain during extreme rainfall events.
                </p>
              </div>
            </div>
      ...
      <motion.div
        initial={false}
        animate={{
          height: isBottomPanelExpanded ? "auto" : "44px",
        }}
                ...
                <AnimatePresence mode="wait">
                  {activeTab === "explanation" && (
                    ...
                    >
                      ...
                      <p className="text-sm text-slate-300 leading-relaxed font-light">
                        “The simulated drainage upgrade significantly reduces
                        flood-related road failures by improving runoff handling
                        capacity along Gandhi Street. While short-term traffic
                        disruption is observed during construction, long-term
                        emergency access and service reliability improve across
                        the ward.”
                      </p>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                          ...
                          <p className="text-xs text-slate-300 font-light">
                            Intervention addresses 72% of surface runoff issues
                            in the Central Zone.
                          </p>
                        </div>
                        <div className="p-3 bg-slate-800/50 rounded-lg border border-slate-700">
                          ...
                          <p className="text-xs text-slate-300 font-light">
                            94% reliability based on historical monsoon rainfall
                            patterns.
                          </p>
                        </div>
                      </div>
                    ...
                    >
                      ...
                      <div className="grid grid-cols-3 gap-4">
                        {[
                          {
                            y: "Year 1",
                            desc: "Construction disruption peak.",
                          },
                          {
                            y: "Year 2-3",
                            desc: "Flood risk stabilizes.",
                          },
                          {
                            y: "Year 4-5",
                            desc: "Resilience maintained.",
                          },
                        ].map((m) => (
                          <div
                            key={m.y}
                            className="p-2 border-l-2 border-slate-700 bg-slate-800/50"
                          >
                            <h5 className="text-[10px] font-bold text-cyan-400">
                              {m.y}
                            </h5>
                      ...
                      <p className="text-[10px] text-slate-500 italic">
                        “Delayed risks are minimal, and benefits compound after
                  ...
                  {activeTab === "suggested" && (
                    ...
                    >
                      {[
                        {
                          title: "Simulate extreme rainfall",
                          desc: "Evaluate performance against 1-in-100 year events.",
                        },
                        {
                          title: "Test phased approach",
                          desc: "Minimize mobility impact through segmented construction.",
                        },
                        {
                          title: "Alternative routing",
                          desc: "Compare drainage via Nehru Lane to reduce utility risk.",
                        },
                      ].map((card, i) => (
                        <div
                          key={i}
                          className="p-4 bg-slate-800 border border-slate-700 rounded-xl hover:border-cyan-500/50 transition-all cursor-pointer group"
                        >
                          <h5 className="text-xs font-bold text-white mb-2 group-hover:text-cyan-400">
                            {card.title}
                          </h5>
      ...
      <div className="px-6 py-2 bg-white border-t border-slate-200 flex justify-between items-center text-[10px] font-medium text-slate-400">
        ...
        <div>Last Simulated: Feb 9, 2026 | CivicSense Core v2.4</div>
      </div>
    </div>
  );
}
